class Main {
  public static void main(String[] args) {
    ...
    //Step 5
    System.out.println("Does creditHours contain IT-1025? " + creditHours.containsKey("IT-1025")); // true
    System.out.println("Does creditHours contain IT-2110? " + creditHours.containsKey("IT-2110")); // false
